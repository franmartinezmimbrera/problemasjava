...
public class LadoTriangulo {
  public static void main(String[] args) {
    ...
    try (Scanner scanner = new Scanner(System.in)) {
      ...
      if (b <= 0 || h <= 0) {
          System.err.println("Error: Las longitudes de los lados deben ser positivas.");
          return;
      }
      
      if (b >= h) {
          System.err.println("Error: La hipotenusa debe ser estrictamente mayor que el cateto.");
          return;
      }
